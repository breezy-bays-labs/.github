...
the Breezy Bays Labs community a harassment-free experience for everyone,
...
If a repository has its own `CODE_OF_CONDUCT.md`, that repository-specific file
takes precedence over this default.

## Reporting

Instances of abusive, harassing, or otherwise unacceptable behavior may be
reported to `breezy-bays-labs@proton.me`.
...
the consequences for action they deem in violation of this Code of Conduct:
...
**Consequence**: A warning with consequences for continued behavior, including a
